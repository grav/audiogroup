...
Ved encoding beregnes et \textit{(runlength, size)} par ud fra en koefficient (samt eventuelle førkommende 0-koefficienter). Parrent slåes op i den relevante tabel, hvorefter resultatet påhæftes vores bitstream sammen med en binær encoding af koefficienten.
